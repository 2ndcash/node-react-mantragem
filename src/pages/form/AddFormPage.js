...
import { _addMoreForm } from '../../actions';
import Upload from '../../components/common/Upload';
import Editor from '../../components/common/Editor'
import { MainLayout } from '../../components/layout'

function AddFormPage({ touched, errors, form, values, setFieldValue }) {

  const head = () => {
    return (
      <Helmet key={Math.random()}>
        <title>Mantragem - Edit Form</title>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    submitHandler: (data) => dispatch(_addMoreForm(data))
  }
}
export default {
