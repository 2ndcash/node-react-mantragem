...
const Header = ({ menus }) => {
  return (<nav className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
      <a className="navbar-brand brand-logo mr-5"><img src="/images/2Cash_green.png" className="mr-2" alt="logo" /></a>
      <a className="navbar-brand brand-logo-mini"><img src="/images/favicon.png" alt="logo" /></a>
    </div>
          ...
          menus.length > 0 ?
            <li className="nav-item nav-profile dropdown">
              <a className="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                <img src="/images/dashboard/2ndcashlogo_whtbg.jpg" alt="profile" />
              </a>
